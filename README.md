...
- Make first run by launching scripts mannually to check that all set up correctly. To test them just put any PDF file into working directory and check logs
